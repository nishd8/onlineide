...
echo '<div class="alert alert-success" role="alert">
 ...
 <button  onclick="location.replace(\'dashboard.php\')"  class="nav-link" style="font-size:15px;border:2px solid #000; background-color: transparent;color: #000;">Dashboard</button>';
