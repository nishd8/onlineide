...
{ 
 ...
 if(isset($_POST['check']))
	...
	{
	  include 'conn.php';
    $q="SELECT * FROM testcase where test_id='$tid'";
...
function javarun($code,$user,$tid)
{ 
