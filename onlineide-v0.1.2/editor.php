...
<body>
	...
	<div class="container-fluid">
     <div class="row">
      ...
      <div class="col-lg-6 md-12 sm-12">
      	<div class="container-fluid edit">
      		...
      		<?php
      		include 'conn.php';
      		$q="SELECT * FROM question where test_id='$tid'";
     ...
     <div class="col-lg-6 md-12 sm-12">
       <div class="container-fluid edit">
       	<?php echo '<form method="POST" action="editor.php?tid='.$tid.'">';?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          if(isset($_POST['run']))
          {
	        ...
	        if($lang=="python")
	        {
	         pyrun($code,$email,$tid);	
	        }
	        else if($lang=="text/x-java")
	        {
	         javarun($code,$email,$tid);	
	        }
	        else if($lang=="text/x-c++src")
	        {
	         cpprun($code,$email,$tid);
	        }
